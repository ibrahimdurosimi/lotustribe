...
export const Calculator = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 p-8 md:p-10 rounded-3xl neo-border neo-shadow border-2 border-black max-w-4xl mx-auto">
      ...
      <div className="grid lg:grid-cols-2 gap-10">
        <div className="space-y-6">
          <div>
            <label className="block text-xs font-bold uppercase mb-3 text-gray-500 dark:text-gray-400">Select Fund</label>
            <div className="grid grid-cols-2 gap-3">
               <button 
                 onClick={() => setFundType('fif')} 
                 className={`p-3 rounded-xl border-2 font-bold text-sm transition-all ${fundType === 'fif' ? 'bg-genz-lime border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]' : 'bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:border-black'}`}
               >
                 Lotus FIF
               </button>
               <button 
                 onClick={() => setFundType('halal')} 
                 className={`p-3 rounded-xl border-2 font-bold text-sm transition-all ${fundType === 'halal' ? 'bg-genz-pink border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]' : 'bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:border-black'}`}
               >
                 Halal Fund
               </button>
            </div>
          ...
          <div>
             <label className="flex justify-between text-xs font-bold uppercase mb-3 text-gray-600 dark:text-gray-300">
                <span>Initial Investment</span>
                <span className="text-black dark:text-white bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-md neo-border shadow-sm text-xs">₦ {initial.toLocaleString()}</span>
             </label>
          ...
          <div>
             <label className="flex justify-between text-xs font-bold uppercase mb-3 text-gray-600 dark:text-gray-300">
                ...
                <span className="text-black dark:text-white bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-md neo-border shadow-sm text-xs">₦ {monthly.toLocaleString()}</span>
             </label>
          ...
          <div>
             <label className="flex justify-between text-xs font-bold uppercase mb-3 text-gray-600 dark:text-gray-300">
                ...
                <span className="text-black dark:text-white bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-md neo-border shadow-sm text-xs">{years} Years</span>
             </label>
        ...
        <div className="bg-lotus-dark text-white rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden neo-shadow border-2 border-black">
           ...
           <div className="mt-8 space-y-4 relative z-10">
              ...
              <div className="pt-3 border-t border-gray-700/50">
                <p className="text-[10px] text-gray-500 dark:text-gray-400 leading-relaxed font-mono">
...
export const InvestFIF = () => {
   return (
      <div className="min-h-screen bg-[#fafafa] dark:bg-[#111] pt-32 pb-24">
         <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-genz-lime rounded-[3rem] p-12 md:p-20 neo-border neo-shadow mb-12 relative overflow-hidden">
               ...
               <div className="max-w-2xl relative z-10">
                  <div className="inline-block px-4 py-2 bg-black text-white font-bold font-display uppercase rounded-xl mb-6 shadow-sm border border-black/20 dark:border-white/20 text-sm tracking-wide">Low Risk 🛡️</div>
                  <h1 className="text-5xl md:text-7xl font-display font-extrabold text-black dark:text-white leading-none uppercase mb-8">Lotus Halal Fixed Income Fund (FIF)</h1>
                  <p className="text-2xl font-medium text-black/80 dark:text-gray-200 max-w-xl">
            ...
            <div className="grid lg:grid-cols-3 gap-12">
               <div className="lg:col-span-2 space-y-12">
                  <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] p-10 neo-border neo-shadow-sm">
                     ...
                     <p className="text-lg text-gray-700 dark:text-gray-200 leading-relaxed mb-6 font-medium">
                     ...
                     <div className="grid sm:grid-cols-2 gap-6 mt-10">
                        <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700">
                           ...
                           <p className="text-gray-600 dark:text-gray-300 font-medium">Travel, Weddings, Masters Programs, Hajj/Umrah, Emergency funds, or Gadgets.</p>
                        </div>
                        <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700">
                           <h4 className="font-bold text-lg mb-2">Income Payout</h4>
                           <p className="text-gray-600 dark:text-gray-300 font-medium">Aims to pay out 80% of profit to investors on a quarterly basis.</p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] p-10 neo-border neo-shadow-sm">
                     ...
                     <div className="overflow-hidden bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 mb-8">
                        <table className="w-full text-left text-sm md:text-base">
                           <tbody className="divide-y divide-gray-200">
                              <tr className="hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                 <th className="py-4 px-6 font-bold text-gray-700 dark:text-gray-200 w-1/3">Fund Manager</th>
                                 <td className="py-4 px-6 font-medium text-gray-600 dark:text-gray-300">Lotus Capital Ltd</td>
                              </tr>
                              <tr className="hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                 <th className="py-4 px-6 font-bold text-gray-700 dark:text-gray-200 w-1/3">Base Currency</th>
                                 <td className="py-4 px-6 font-medium text-gray-600 dark:text-gray-300">Naira (NGN)</td>
                              </tr>
                              <tr className="hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                 <th className="py-4 px-6 font-bold text-gray-700 dark:text-gray-200 w-1/3">Launch Date</th>
                                 <td className="py-4 px-6 font-medium text-gray-600 dark:text-gray-300">May 2008</td>
                              </tr>
                              <tr className="hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                 <th className="py-4 px-6 font-bold text-gray-700 dark:text-gray-200 w-1/3">Management Fee</th>
                                 <td className="py-4 px-6 font-medium text-gray-600 dark:text-gray-300">1.5% per annum</td>
                              </tr>
                              <tr className="hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                 <th className="py-4 px-6 font-bold text-gray-700 dark:text-gray-200 w-1/3">Target Assets</th>
                                 <td className="py-4 px-6 font-medium text-gray-600 dark:text-gray-300">Sukuk (Sovereign & Corporate), Halal Fixed placements</td>
                              </tr>
                           </tbody>
                        </table>
                     </div>
                     ...
                     <ul className="grid sm:grid-cols-2 gap-4">
                        {[
                           ...
                           <li key={i} className="flex items-start gap-4 text-lg font-medium text-gray-700 dark:text-gray-200 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-800">
               ...
               <div className="space-y-8">
                  <div className="bg-lotus-dark text-white rounded-[2.5rem] p-8 neo-border neo-shadow sticky top-32">
                     ...
                     <Link to="/invest/onboarding" state={{ fund: 'fif' }} className="w-full neo-btn bg-genz-lime text-black dark:text-white text-xl py-4 flex justify-center items-center gap-2">
      ...
      <div className="min-h-screen bg-[#fafafa] dark:bg-[#111] pt-32 pb-24">
         <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-genz-pink rounded-[3rem] p-12 md:p-20 neo-border neo-shadow mb-12 relative overflow-hidden">
               ...
               <div className="max-w-2xl relative z-10">
                  <div className="inline-block px-4 py-2 bg-black text-white font-bold font-display uppercase rounded-xl mb-6 shadow-sm border border-black/20 dark:border-white/20 text-sm tracking-wide">Moderate Risk 📈</div>
                  <h1 className="text-5xl md:text-7xl font-display font-extrabold text-black dark:text-white leading-none uppercase mb-8">Lotus Halal Investment Fund</h1>
                  <p className="text-2xl font-medium text-black/80 dark:text-gray-200 max-w-xl">
            ...
            <div className="grid lg:grid-cols-3 gap-12">
                  ...
                  <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] p-10 neo-border neo-shadow-sm">
                     ...
                     <div className="grid sm:grid-cols-2 gap-6 mt-10">
                        <div className="p-6 bg-pink-50 rounded-2xl border border-pink-200">
                           <h4 className="font-bold text-lg mb-2">Fund Goals</h4>
                           <p className="text-gray-600 dark:text-gray-300 font-medium">Retirement planning, child's education, creating generational wealth.</p>
                        </div>
                        <div className="p-6 bg-pink-50 rounded-2xl border border-pink-200">
                           <h4 className="font-bold text-lg mb-2">Income Payout</h4>
                           <p className="text-gray-600 dark:text-gray-300 font-medium">Dividends are paid periodically at the discretion of the Fund Manager.</p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] p-10 neo-border neo-shadow-sm">
                     ...
                     <div className="overflow-hidden bg-pink-50/30 rounded-2xl border border-pink-100 mb-8">
                        <table className="w-full text-left text-sm md:text-base">
                           <tbody className="divide-y divide-pink-100">
                              ...
                              <tr className="hover:bg-pink-50 transition-colors">
                                 <th className="py-4 px-6 font-bold text-gray-700 dark:text-gray-200 w-1/3">Launch Date</th>
                                 <td className="py-4 px-6 font-medium text-gray-600 dark:text-gray-300">August 2008</td>
                              </tr>
                              <tr className="hover:bg-pink-50 transition-colors">
                                 <th className="py-4 px-6 font-bold text-gray-700 dark:text-gray-200 w-1/3">Management Fee</th>
                                 <td className="py-4 px-6 font-medium text-gray-600 dark:text-gray-300">1.5% per annum</td>
                              ...
                              <tr className="hover:bg-pink-50 transition-colors">
                                 <th className="py-4 px-6 font-bold text-gray-700 dark:text-gray-200 w-1/3">Target Assets</th>
                                 <td className="py-4 px-6 font-medium text-gray-600 dark:text-gray-300">Equities & Halal Fixed Income (Diversified)</td>
                              </tr>
                              <tr className="hover:bg-pink-50 transition-colors">
                                 <th className="py-4 px-6 font-bold text-gray-700 dark:text-gray-200 w-1/3">Benchmark</th>
                                 <td className="py-4 px-6 font-medium text-gray-600 dark:text-gray-300">NSE Lotus Islamic Index (NSELII)</td>
                              </tr>
                           </tbody>
                        </table>
                     </div>
                     ...
                     <ul className="grid sm:grid-cols-2 gap-4">
                        {[
                           ...
                           <li key={i} className="flex items-start gap-4 text-lg font-medium text-gray-700 dark:text-gray-200 p-4 bg-pink-50 rounded-xl border border-pink-100">
               ...
               <div className="space-y-8">
                  <div className="bg-lotus-dark text-white rounded-[2.5rem] p-8 neo-border neo-shadow sticky top-32">
                     ...
                     <Link to="/invest/onboarding" state={{ fund: 'halal' }} className="w-full neo-btn bg-genz-pink text-black dark:text-white text-xl py-4 flex justify-center items-center gap-2">
                        Get Started <ChevronRight />
                     </Link>
                  </div>
               </div>
